...
- **余额追踪** — 展示已确认和未确认余额
- **交易历史** — 查看每个地址的最近交易记录（24小时制时间）
- **导入/导出** — 备份和恢复观察列表
- **批量刷新** — 一键更新所有地址
- **主动锁屏** — 离开电脑时一键返回密码解锁界面，保护隐私
...
- **深色模式** — 支持系统浅色/深色外观自动切换
- **主动锁屏** — 一键锁定按钮，立即返回密码解锁界面
- **24小时制** — 所有时间戳统一为 24 小时制显示
- **单文件完整** — favicon 以 base64 内嵌，恢复纯单文件 SPA
- **GitHub Actions 部署** — 自动维护 CNAME 自定义域名
